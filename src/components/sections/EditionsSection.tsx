export const EditionsSection = () => {
  return (
    <section className="flex gap-5 items-start justify-start bg-edition-banner bg-cover max-sm:bg-none flex-col w-full min-w-[100vw] max-sm:min-w-full mx-[-6.25rem] max-sm:mx-auto h-full max-lg:px-0  py-[5.75rem]">
